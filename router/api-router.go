...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/routes", controller.GetModelRouteBindings)
			modelsRoute.GET("/routes/candidates", controller.GetModelRouteCandidates)
			modelsRoute.PUT("/routes", controller.SaveModelRouteBinding)
			modelsRoute.DELETE("/routes", controller.DisableModelRouteBinding)
